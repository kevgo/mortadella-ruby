Feature: Drying up repetitive fields
  ...
  So that I can see better how data in my table is grouped and where changes.


  Scenario: drying up repetitive columns
    Given I create a Mortadella instance with a few DRY columns  "m = Mortadella.new headers: ['DAY', 'ACTIVITY'], dry: ['DAY']"
    ...
    Then I receive a table with repetitive days cleared out for better readability
      | DAY     | ACTIVITY  |
      | Monday  | mowing    |
      |         | musing    |
      |         | mentoring |
